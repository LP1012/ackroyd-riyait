...
_Note: Do not include the {} from the make command line, replace the whole {insert type here} text with the command corresponding to the correct file type._

_Ex: To make as a pdf, the full command should be: `make all-via-pdf`_
