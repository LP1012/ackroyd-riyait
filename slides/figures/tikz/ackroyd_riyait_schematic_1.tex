\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.3]
    \draw[fill=MaterialColor,very thick] (0,0) rectangle (10,10);
    \draw[fill=VoidColor,very thick] (0,0) rectangle (5,5);
    \draw[fill=SourceColor,very thick] (0,0) rectangle (1.25,1.25);
  ...
  \end{tikzpicture}
  \caption{Schematic of first configuration of the Ackroyd-Riyait problems.}
\end{figure}