\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.15]
    \draw[fill=MaterialColor,very thick,draw=MaterialColor] (3,0) rectangle (14,18);
    \draw[fill=VoidColor,very thick,draw=VoidColor] (0,0) rectangle (3,15);
  ...
  \end{tikzpicture}
  \caption{\footnotesize Schematic of \gls{arp2}.}
\end{figure}