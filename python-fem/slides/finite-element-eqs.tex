...
\begin{frame}
  ...
  \begin{multline}
    \int_\mathcal{A}\sum_nA_n\dd \ohat\int_\tau\sum_mT_mS\dd\tau =
    \frac{1}{4\pi}\sum_{i,j,m,n}\left[\Sigma_{s,i}\int_\tau T_iT_m\dd\tau\int_\mathcal{A} A_jA_n\dd\ohat \psi_{ij}\right]+\\+
...
\begin{frame}[allowframebreaks]
  ...
  \begin{multline}
    ...
    \sigt K\otimes M\Psi = \left[S\otimes K\right]\Psi+\vec{Q}\otimes \vec{A}
  \end{multline}
