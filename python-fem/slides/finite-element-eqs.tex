...
\begin{frame}
  ...
  \begin{equation}
    \pm \int_\mathcal{A}\oint_{\partial\tau_v}v\psiplus\ohat\cdot\hat{n}\dd s\dd \ohat
  \end{equation}
...
\begin{frame}
  ...
  \begin{multline}\label{eq:function-exp-fem}
    \pm\int_{\mathcal{A}}\oint_{\partial\tau}v\sum_i\sum_j \psi_{ij}T_iA_j\left(\mu n_x+\eta n_y\right)\dd s\dd\ohat +\\+
